...
var nativescript_geolocation_common_1 = require("./nativescript-geolocation-common");
...
function locationFromCLLocation(clLocation) {
    var location = new nativescript_geolocation_common_1.Location();
...
function getCurrentLocation(options) {
    ...
    return new Promise(function (resolve, reject) {
        ...
        if (typeof options.timeout === "number") {
            ...
            }, options.timeout || nativescript_geolocation_common_1.defaultGetLocationTimeout);
        }
    });
}
